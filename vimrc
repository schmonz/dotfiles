...
autocmd FileType perl,ruby,sh,javascript,typescript,c,cpp,yaml,make setlocal number|let w:m2=matchadd('Search', '\%>80v.\+', -1)
...
autocmd FileType textile,markdown,ikiwiki,javascript,typescript,objc,cpp setlocal expandtab tabstop=4 shiftwidth=4 softtabstop=4
autocmd FileType typescript,objc,cpp setlocal expandtab tabstop=2 shiftwidth=2 softtabstop=2
